...
export const grievances = [
  { id: 1, citizenId: 1, category: "water", subject: "Water supply disrupted for 3 days", description: "Ward 2 has not received regular water supply due to pump motor failure.", attachment: null, status: "resolved", referenceNumber: "GRV-ABC123", assignedTo: 2, resolution: "Pump motor repaired and supply restored on 2026-06-18.", createdAt: new Date("2026-06-14"), resolvedAt: new Date("2026-06-18") },
  { id: 2, citizenId: 5, category: "roads", subject: "Potholes on main road need repair", description: "The road connecting Ward 3 to the highway has several dangerous potholes.", attachment: null, status: "assigned", referenceNumber: "GRV-DEF456", assignedTo: 2, resolution: null, createdAt: new Date("2026-06-16"), resolvedAt: null },
  { id: 3, citizenId: 8, category: "electricity", subject: "Frequent power cuts near school", description: "Power cuts in Ward 2 are affecting evening study hours for students.", attachment: null, status: "under_review", referenceNumber: "GRV-GHI789", assignedTo: null, resolution: null, createdAt: new Date("2026-06-17"), resolvedAt: null },
  { id: 4, citizenId: 6, category: "sanitation", subject: "Drainage blockage near community hall", description: "Blocked drainage is causing stagnant water near Ward 4 community hall.", attachment: null, status: "submitted", referenceNumber: "GRV-JKL012", assignedTo: null, resolution: null, createdAt: new Date("2026-06-19"), resolvedAt: null },
] as const;
